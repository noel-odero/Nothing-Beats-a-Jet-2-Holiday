  ...
  return (
    <div className="font-sans w-full bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 text-slate-900">
      ...
      <main>
        <section className="container-responsive pt-12 md:pt-20 pb-32">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div className="flex flex-col gap-6">
              ...
              <h1 className="text-4xl sm:text-5xl md:text-[5rem] font-extrabold tracking-tight text-slate-900">
        ...
        <section className="container-responsive bg-white rounded-4xl text-slate-900 p-6 md:px-12 md:py-20 mb-20 shadow-xl border border-slate-200">
          ...
          <div className="grid md:grid-cols-2 gap-10 pt-8 items-start">
            <div className="space-y-5">
              <p className="text-slate-900 text-lg font-medium leading-7">
        ...
        <section className="container-responsive pt-12 md:pt-20 pb-32">
          <h1 className="text-2xl sm:text-3xl text-center font-bold mb-12 text-slate-900">
            Our Impact
          </h1>
                ...
                <div className="flex items-center gap-1 mb-4">
                  {Array.from({ length: 5 }).map((_, i) => (
                    <Star
                      key={i}
                      className={`size-4 ${
                        i < r.rating ? 'text-yellow-400' : 'text-slate-300'
                      }`}
